...
_MESSAGES = {
    ...
    "report_canary_missing_detail": "A required Canary hit detail is missing.",
    "report_canary_extra_detail": "An undeclared Canary hit detail is present.",
    "report_canary_duplicate_detail": "A Canary hit detail grouping key is duplicated.",
    "report_canary_detail_order_mismatch": "Canary hit details are not in scenario and mode order.",
    "report_canary_trace_mismatch": "A Canary hit detail trace does not match its mode result.",
    "report_canary_missing_detection": "A violating Canary detection is missing from its detail.",
    "report_canary_extra_detection": "A Canary detail contains an undeclared detection.",
    "report_canary_duplicate_detection": "A Canary detail contains a duplicate detection key.",
    "report_canary_detection_order_mismatch": "Canary detections are not in stable type and evidence order.",
    "report_canary_detection_field_mismatch": "A Canary detail detection differs from its source evidence.",
